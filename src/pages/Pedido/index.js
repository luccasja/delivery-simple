        ...
        <Container>
            <Row style={{textAlign:'center', paddingBottom:10}}>
                ...
                <Col md='8' style={{background:'#FFF', padding:20, borderRadius:8}}>
                    <Image src={Logo} style={{height:50, marginBottom:20, width:50}} alt='logo' />
                    <Row>
                        <Col>
                    ...
                    <Row style={{margin:0}}>
                        <Col style={{padding:0}}>
                            <ul className="lista-produtos" style={{padding:0,}} >
                                <li style={{listStyle:'none'}}>
                                    <Row style={{borderBottomStyle:'solid', borderBottomColor:'#e3e3e3', borderBottomWidth:0.5, paddingTop:5, paddingBottom:5}}>
                                        ...
                                        <Col xs='3' style={{padding:15}}>
                                            <p style={{fontSize:20}}>R$<strong>3,00</strong></p>
                                        </Col>
                                        <Col xs='2' style={{paddingTop:15}}>
                                        <Image src={Add} roundedCircle style={{height:30, width:30}} alt='Adicionar' />
                                        </Col>
                                    </Row>
                                </li>
                                <li style={{listStyle:'none'}}>
